/** Placeholder copy until legal provides final Terms and Conditions. */
export const TERMS_DEMO_LAST_UPDATED = '2 June 2026';

export const TERMS_DEMO_SECTIONS: { title: string; body: string }[] = [
  {
